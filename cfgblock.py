...
class CFGBlock:
	...
	outputdict = {0:[0]}
		...
		if self._blockID in outputdict:
			outputdict[self._blockID].append(e.getReachableBlock().getBlockID())
			
		else:
			neigb = []
			neigb.append(e.getReachableBlock().getBlockID())
			outputdict[self._blockID] = neigb
